    ...
    <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto mt-5">
        <div class="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-6 lg:gap-x-12">
            ...
            <div class="lg:col-span-2">
                <div class="py-8 lg:pr-4 lg:pr-8">
                    <div class="space-y-5 lg:space-y-8">
                        ...
                        <p class="text-3xl font-bold lg:text-4xl lg:text-5xl dark:text-white">Pak Bambang</p>
                        <p class="mb-4 text-xl font-extrabold leading-none text-gray-900 md:text-2xl dark:text-white">$2999
                        </p>
                        ...
                        <p class="text-lg text-gray-800 dark:text-gray-200">We're proud to be a part of creating a more
                            open culture and to continue building a product that supports this vision.</p>

                        <div class="text-center">
                            <div class="grid lg:grid-cols-2 gap-3">
                                <div class="grid grid-cols-2 lg:grid-cols-1 gap-3">
                                    <figure class="relative w-full h-60">
                                        <img class="w-full h-full absolute top-0 left-0 object-cover rounded-xl"
                        ...
                        <p class="text-lg text-gray-800 dark:text-gray-200">As we've grown, we've seen how Preline has
                        ...
                        <p class="text-lg text-gray-800 dark:text-gray-200">That's why we are excited to share that we
                            now have a <a class="text-blue-600 decoration-2 hover:underline font-medium" href="#">free
                                version of Preline</a>, which will allow individual designers,
                        ...
                        <div class="space-y-3">
                            ...
                            <p class="text-lg text-gray-800 dark:text-gray-200">We know the power of sharing is real,
                        ...
                        <ul class="list-disc list-outside space-y-5 pl-5 text-lg text-gray-800 dark:text-gray-200">
                            <li class="pl-2">Preline allows us to collaborate in real time and is a really great way
                                for leadership on the team to stay up-to-date with what everybody is working on," <a
                                    class="text-blue-600 decoration-2 hover:underline font-medium" href="#">said</a>
                                Stewart Scott-Curran, Intercom's Director of Brand Design.
                            </li>
                            <li class="pl-2">Preline opened a new way of sharing. It's a persistent way for everyone
                                to see and absorb each other's work," said David Scott, Creative Director at <a
                                    class="text-blue-600 decoration-2 hover:underline font-medium"
                                    href="#">Eventbrite</a>.</li>
                        </ul>

                        <p class="text-lg text-gray-800 dark:text-gray-200">Small teams and individual designers need a
            ...
            <div
                ...
                <div class="top-0 left-0 py-8 lg:pl-4 lg:pl-8">
                                                    ...
                                                    <div class="w-full h-full">
                                                        <div
                                                            ...
                                                            <a role="link" tabindex="0"
                                                                class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-red-700 focus:bg-red-500 hover:bg-red-500 text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-red-700 rounded-full">8</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
